...
//
// NOTE: the app's "Deploy to GitHub" button pushes index.html ONLY — this file
// must be uploaded to the `crm` repo manually (GitHub web UI) after any change.
...
self.addEventListener('push', (event) => {
  ...
  const title = data.title || 'Chabad at the Falls';
  const options = {
    body: data.body || '',
    icon: './icon-192.png',
    badge: './icon-192.png',
